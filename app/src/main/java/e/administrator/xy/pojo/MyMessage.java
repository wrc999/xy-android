...
public class MyMessage implements IMessage {
    ...
    private String timeString;//信息发送事件
    private int type;   //发送的信息类型
    private IUser user;//发送消息的用户
    private String mediaFilePath;//聊天图片
    private long duration;//语音时间
    private String progress;//旋转圆圈
    private MessageStatus mMsgStatus = MessageStatus.CREATED;//聊天信息前的状态信息（正在发送，发送成功/失败）
