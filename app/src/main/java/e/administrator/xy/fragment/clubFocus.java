 ...
 */
public class clubFocus extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout =inflater.inflate(R.layout.fragment_club_focus,null);
        init(layout);
        initRefreshLayout();
        initData();
        return layout;
    ...
    private void initData() {
        ...
        client.post(constant.BASE_URL+constant.club_findMyFocus, params,new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                try {
                    ...
                    if (!clubList.isEmpty()){
                        mRecyclerView = (RecyclerView) getActivity().findViewById(R.id.myCLubFocusRecyclerView);
    ...
    private void init(View layout) {
        refreshLayout = layout.findViewById(R.id.refresh_myclubFocus);
    }
