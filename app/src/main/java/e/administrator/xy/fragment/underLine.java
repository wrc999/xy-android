...
public class underLine extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout =inflater.inflate(R.layout.fragment_under_line,null);
        init(layout);
        initRefreshLayout();
        initData();
        return layout;
    ...
    private void initData() {
        ...
        client.post(constant.BASE_URL + constant.activity_getUnderLine, params, new AsyncHttpResponseHandler() {
            @Override
                ...
                if (json!=null){
                    try {
                        ...
                        if (!activityList.isEmpty()){
                            mRecyclerView = (RecyclerView) getActivity().findViewById(R.id.myActivityUnderlineRecyclerView);
                            mRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
                            ActivityAdapter adapter = new ActivityAdapter(getContext(),activityList);
                            mRecyclerView.setAdapter(adapter);
                        }else {
                            Toast.makeText(getContext(), "你还没参与任何线下活动哟", Toast.LENGTH_SHORT).show();
                        }
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
    ...
    private void init(View layout) {
        refreshLayout = layout.findViewById(R.id.refresh_myActivityUnderline);
    }
}
